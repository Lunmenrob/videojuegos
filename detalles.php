 ...
 * - Banner, icono, título y plataforma
 * - Información de trofeos (ganados, disponibles, por tipo)
 * - Detalles del juego (dificultad, duración, trofeos offline/online)
 * - Galería multimedia (carrusel de imágenes/videos)
 * - Lista de trofeos con filtros
 * - Sección de DLCs
...
<link rel="stylesheet" href="estilos/css/detalles.css?v=8">
